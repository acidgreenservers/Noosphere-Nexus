...
This file provides guidance for Gemini agents when working with code in this repository.
...
# Start development server (runs on http://localhost:5173/Noosphere-Nexus/)
npm run dev

# Build for production (outputs to ./dist with SPA 404 fallback)
npm run build
...
- Framework docs and research guides are located in `/src/pages/docs/`.
...
- **PrismJS / Marked** - Syntax highlighting and markdown rendering
